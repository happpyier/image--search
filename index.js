...
app.get('/:id', function(request, response) {
  ...
  var API_KEY = secretKey; // specify your API key here
	urlsearch.cse.list({ cx: '012239477241375126935:swwmv-c4dsi', q: parameters1, num: 10, searchType: 'image', fields: 'items(image/contextLink,link,snippet)', start: parameters2, key: 'AIzaSyBO5IZ8i0lpF9I0eMwZ9E4nNV3jXkyUuHM' }, function(err, user) 
	{
